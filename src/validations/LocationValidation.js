...
const LocationValidation = {
  create: [
    body('name')
      ...
      .isString()
      .withMessage('Location name must be a valid string'),
    body('type')
      .notEmpty()
  ...
  getById: [param('id').isInt().withMessage('Location ID must be a valid integer')],

  delete: [param('id').isInt().withMessage('Location ID must be a valid integer')],
