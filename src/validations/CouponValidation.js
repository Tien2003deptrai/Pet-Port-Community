...
const CouponValidation = {
  create: [
    body('code')
      ...
      .isString().withMessage('Coupon code must be a valid string'),
    body('description')
      .optional()
      .isString().withMessage('Description must be a valid string'),
    body('discount_type')
      .notEmpty().withMessage('Discount type is required')
      .isIn(['Percentage', 'Fixed Amount']).withMessage('Discount type must be either Percentage or Fixed Amount'),
    body('discount_value')
  ...
  update: [
    ...
    body('discount_type').optional().isIn(['Percentage', 'Fixed Amount']).withMessage('Discount type must be either Percentage or Fixed Amount'),
